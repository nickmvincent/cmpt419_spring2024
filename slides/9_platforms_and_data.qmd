...
- Today's goal: briefly introduce some ways that platform design choices and norms affect current and future data
...
- The next few slides provides a bunch of examples, from (examples from: https://github.com/nickmvincent/UGCValueRoundup/blob/main/wikipedia.md)
- For 419, you're not expected to memorize any facts about these.
...
## Wikipedia text as training data (page 2)
...
## Wikipedia text as training data (page 3)
...
- See e.g. https://huggingface.co/datasets/wikitext
...
## Selecting on platform design

- We select on Wikipedia because of the Wikipedia design principles / norms
- But thus we're subject to weird governance boundaries (what exactly is a "Good" article)
...
- The button design, how it's communicated...
